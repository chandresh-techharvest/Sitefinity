...
namespace CMSSample.ResourcePackages.Bootstrap4.MVC.Views.Profile
{
    using System;
...
Write(Html.Script("//ajax.aspnetcdn.com/ajax/jquery.validate/1.19.3/jquery.validate.js", "top", false));
...
WriteAttribute("id", Tuple.Create(" id=\'", 1344), Tuple.Create("\'", 1392)
            
            #line 33 "..\..MVC\Views\Profile\ConfirmPassword.ProfileEdit.cshtml"
, Tuple.Create(Tuple.Create("", 1349), Tuple.Create<System.Object, System.Int32>(Html.UniqueId("PasswordChangeDescription")
...
WriteAttribute("id", Tuple.Create(" id=\'", 1858), Tuple.Create("\'", 1912)
            
            #line 42 "..\..MVC\Views\Profile\ConfirmPassword.ProfileEdit.cshtml"
, Tuple.Create(Tuple.Create("", 1863), Tuple.Create<System.Object, System.Int32>(Html.UniqueId("PasswordChangeValidationMessage")
...
WriteAttribute("value", Tuple.Create(" value=\'", 2179), Tuple.Create("\'", 2220)
            
            #line 48 "..\..MVC\Views\Profile\ConfirmPassword.ProfileEdit.cshtml"
              , Tuple.Create(Tuple.Create("", 2187), Tuple.Create<System.Object, System.Int32>(Html.Resource("EditProfileSave")
